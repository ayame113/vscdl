...
// source-hash: 170aef1807d9c904df239db9dd3dfeb590deb176
let wasm;
...
const MyStructFinalization = new FinalizationRegistry((ptr) =>
 ...
 *   exports: { lint: typeof lint; MyStruct : typeof MyStruct  }
 * }>}
 */
export async function instantiateWithInstance(opts) {
  const { instance } = await loader.load(
    opts?.url ?? new URL("vscode_deno_lint_bg.wasm", import.meta.url),
    opts?.decompress,
  );
